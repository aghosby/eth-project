...
@Component({
  selector: 'app-vote-transactions',
  templateUrl: './vote-transactions.component.html',
  styleUrls: ['./vote-transactions.component.scss']
})
export class VoteTransactionsComponent implements OnInit  {
  ...
  ngOnInit(): void {
    ...
    this.tableData$ = merge(
      ...
      map(res => (res ? res.data.votes : this.tableData)),
